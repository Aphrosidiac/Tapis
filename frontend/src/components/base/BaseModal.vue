    ...
    >
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div
          ...
          class="card relative flex max-h-[88vh] w-full flex-col shadow-lg"
          :class="sizes[size]"
        >
          ...
          <footer v-if="$slots.footer" class="flex justify-end gap-2 border-t border-line-100 bg-surface-50 px-6 py-4">
            <slot name="footer" />
          </footer>
        </div>
      </div>
